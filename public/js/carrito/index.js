(function($) {
  $(document).ready(function() {
      ...
      //http://localhost/prophp3bj/ecommerce/Apicarrito/completar_carrito
      $("#btncompletar_carrito").on("click",function(){
        //alert(token);
        let url= $("#url").val();
        let urlReq =url+"apicarrito/completar_carrito";
