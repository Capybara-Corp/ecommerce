...
class api_carrito_controller extends controller
{
    ...
    //localhost/prophp3bj/ecommerce/Apicarrito/completar_carrito
    public function completar_carrito()
    {
        try {
            ...
            $resultado = $this->model->completar_carrito($lista, $usuario);
            ...
            $this->view->render('api/carrito/completar_carrito');
            //code...
